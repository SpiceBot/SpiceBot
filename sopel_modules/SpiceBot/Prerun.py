...
def updatable_content(bot, botcom, trigger):
    ...
    if botcom.dict["dict"][botcom.dict["responsekey"]]["updates_enabled"]:
        ...
        if botcom.dict["dict"][botcom.dict["responsekey"]]["updates_enabled"] == "shared":
            customresponses = botdb.get_nick_value(str(bot.nick), botcom.dict["dict"]["realcom"][0] + "_" + str(botcom.dict["responsekey"]), 'sayings') or []
        elif botcom.dict["dict"][botcom.dict["responsekey"]]["updates_enabled"] == "user":
            customresponses = botdb.get_nick_value(str(trigger.nick), botcom.dict["dict"]["realcom"][0] + "_" + str(botcom.dict["responsekey"]), 'sayings') or []
        if not len(customresponses):
            ...
            if botcom.dict["dict"][botcom.dict["responsekey"]]["updates_enabled"] == "shared":
                botdb.set_nick_value(str(bot.nick), botcom.dict["dict"]["realcom"][0] + "_" + str(botcom.dict["responsekey"]), savevalues, 'sayings')
            elif botcom.dict["dict"][botcom.dict["responsekey"]]["updates_enabled"] == "user":
                botdb.set_nick_value(str(trigger.nick), botcom.dict["dict"]["realcom"][0] + "_" + str(botcom.dict["responsekey"]), savevalues, 'sayings')
        else:
...
def trigger_hyphen_arg_handler(bot, trigger, botcom):
    ...
    # handle numbered args
        ...
        if botcom.dict["hyphen_arg"] in ['add']:
            ...
            if botcom.dict["dict"][botcom.dict["responsekey"]]["updates_enabled"] == "shared":
                botdb.set_nick_value(str(bot.nick), botcom.dict["dict"]["realcom"][0] + "_" + str(botcom.dict["responsekey"]), customresponses, 'sayings')
            elif botcom.dict["dict"][botcom.dict["responsekey"]]["updates_enabled"] == "user":
                botdb.set_nick_value(str(trigger.nick), botcom.dict["dict"]["realcom"][0] + "_" + str(botcom.dict["responsekey"]), customresponses, 'sayings')
            ...
            if fulltext not in customresponses:
